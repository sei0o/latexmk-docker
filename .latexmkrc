...
$lualatex         = "find . -type f -name '*.tex' -print0 | xargs -0 sed -i -e 's/、/，/g' -e 's/。/．/g' && lualatex -synctex=1 -interaction=nonstopmode -shell-escape -halt-on-error";
$xelatex          = "find . -type f -name '*.tex' -print0 | xargs -0 sed -i -e 's/、/，/g' -e 's/。/．/g' && xelatex -synctex=1 -interaction=nonstopmode -shell-escape -halt-on-error";
$bibtex           = "upbibtex";
